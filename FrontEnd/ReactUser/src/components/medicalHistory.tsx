...
//   // פונקציה לחילוץ userId מה-JWT token
...
//           `https://fullstackproject-5070.onrender.com/api/TestResualt?userId=${UserId}`,
//           {
//             method: 'GET',
//             headers,
//           }
...
//           // סינון הנתונים לפי userId (כפילות הגנה)
//           const filteredData = data.filter((item: any) => 
//             item.userId === UserId || item.userId === UserId.toString()
//           )
      ...
      try {
        ...
        const response = await fetch(
          `https://fullstackproject-5070.onrender.com/api/TestResualt?userId=${UserId}`,
          {
            method: 'GET',
            headers,
            // הסרת credentials: 'include' כדי למנוע שגיאת CORS
          }
        )
