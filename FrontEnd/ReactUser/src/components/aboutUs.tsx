...
export const AboutUs = () => {
    ...
    const galleryImages = [
        { id: 1, src: "../src/images/img2.jpg", alt: "hospital img" },
        { id: 2, src: "../src/images/img3.jpg", alt: "hospital img" },
        { id: 3, src: "../src/images/img4.jpg", alt: "hospital img" },
        { id: 4, src: "../src/images/img5.jpg", alt: "hospital img" },
        { id: 5, src: "../src/images/img6.jpg", alt: "hospital img" },
        { id: 6, src: "../src/images/img7.jpg", alt: "hospital img" },
        { id: 7, src: "../src/images/img8.jpg", alt: "hospital img" },
        { id: 8, src: "../src/images/img9.jpg", alt: "hospital img" },
        { id: 9, src: "../src/images/img10.jpg", alt: "hospital img" },
        {id :10, src: "../src/images/img11.jpg", alt: "hospital img"},
    ];
