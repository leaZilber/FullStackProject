...
// // יצירת ערכת נושא מותאמת אישית עם הצבעים שציינת
...
//       //   // שמירת פרטי המשתמש - בדיקה שהם קיימים בתשובה
...
//         // FIX: Correct property names to match backend response
//         if (response.data.userName) {
//           sessionStorage.setItem("userName", response.data.userName); // Fixed: was response.data.UserName
//         }
        
//         if (response.data.email) {
//           sessionStorage.setItem("email", response.data.email); // Fixed: was response.data.UserEmail
//         }
        
//         if (response.data.role) {
//           sessionStorage.setItem("role", response.data.role); // Fixed: was response.data.UserRole
//         }
        
//         if (response.data.userId) {
//           sessionStorage.setItem("userId", response.data.userId.toString()); // Fixed: was response.data.UserId
//         }
