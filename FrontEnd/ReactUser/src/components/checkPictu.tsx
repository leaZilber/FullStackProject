...
//     <div className="animate-spin rounded-full h-12 w-12 border-b-2 mb-4" style={{ borderColor: theme.primary }}></div>
...
//         <div className="flex-shrink-0 ml-3" style={{ color: theme.primary }}>
//           {type === "success" && "✓"}
//           {type === "error" && "✕"}
//           {type === "warning" && "⚠"}
//           {type === "info" && "ℹ"}
...
// const ObjectDetectionDisplay = ({
//   detectedObjects,
//   imageUrl,
// }: { detectedObjects?: DetectedObject[]; imageUrl: string }) => {
//   // Early return if no detected objects or empty array
...
//                   <div className="w-4 h-4 rounded-full ml-3" style={{ backgroundColor: theme.primary }}></div>
...
//                             ? theme.warning + "20"
//                             : theme.error + "20",
//                       color: obj.confidence > 0.8 ? theme.success : obj.confidence > 0.6 ? theme.warning : theme.error,
//                     }}
//                   >
...
//           const parsedId = Number.parseInt(id.toString(), 10)
...
//       console.log("checkSkinCancer result:", result)

//       if (result.success) {
//         setFeedback(result.summary)
//         setAnalysisComplete(true)

//         // Only set detected objects if they exist and are valid
...
//             setError(
//               `התוצאה נותחה בהצלחה אך לא נשמרה: ${saveError instanceof Error ? saveError.message : "שגיאה לא ידועה"}`,
//             )
...
//         if (
//           result.summary?.includes("חשש כבד") ||
...
//   return (
//     <div dir="rtl" className="min-h-screen py-8" style={{ backgroundColor: theme.background }}>
//       <div className="max-w-4xl mx-auto px-4">
//         <div className="rounded-xl shadow-lg p-6 mb-8" style={{ backgroundColor: theme.surface }}>
//           <div className="flex items-center justify-center mb-4">
//             <div className="p-3 rounded-full ml-3" style={{ backgroundColor: `${theme.primary}20` }}>
...
//             <div className="flex items-center">
//               <span className="ml-2">{isLoggedIn ? "👤" : "👥"}</span>
...
//             <div className="text-center text-sm mb-4" style={{ color: theme.textSecondary }}>
...
//                     </div>
//                     <div className="text-base leading-relaxed">{feedback}</div>
//                     {currentTestResualt && (
...
//                 {/* Display detected objects - now with proper null checking */}
//                 <ObjectDetectionDisplay detectedObjects={detectedObjects} imageUrl={image} />
...
//           <div className="rounded-xl shadow-lg p-6" style={{ backgroundColor: theme.surface }}>
...
//                             getSeverityType(test.Summary) === "success"
//                               ? "bg-green-100 text-green-800"
//                               : getSeverityType(test.Summary) === "warning"
//                                 ? "bg-yellow-100 text-yellow-800"
//                                 : getSeverityType(test.Summary) === "error"
...
//                         </div>
//                       </div>
//                       <p className="text-sm leading-relaxed mb-2" style={{ color: theme.textPrimary }}>
//                         {test.Summary.length > 150 ? `${test.Summary.substring(0, 150)}...` : test.Summary}
//                       </p>
//                     </div>
//                     {test.ImgURL && (
//                       <div className="mr-4 flex-shrink-0">
//                         <img
//                           src={test.ImgURL || "/placeholder.svg"}
//                           alt="תמונת הבדיקה"
...
//         <div className="rounded-xl shadow-lg p-6 mt-8" style={{ backgroundColor: theme.surface }}>
//           <div className="text-center" style={{ color: theme.textSecondary }}>
//             <p className="text-sm">זוהי מערכת בדיקה מקדמית והיא אינה מחליפה בדיקה רפואית מקצועית</p>
//           </div>
//         </div>
//       </div>
//     </div>
  ...
  return (
    <div dir="rtl" className="min-h-screen py-8" style={{ backgroundColor: theme.background }}>
      <div className="max-w-4xl mx-auto px-4">
        ...
        {isLoggedIn && testHistory && Array.isArray(testHistory) && testHistory.length > 0 && (
          <div className="rounded-xl shadow-lg p-6" style={{ backgroundColor: theme.surface }}>
            <div className="flex items-center mb-6">
              <span className="text-2xl ml-3">📋</span>
              <h2 className="text-2xl font-bold" style={{ color: theme.textPrimary }}>
            ...
            <div className="space-y-4">
              {testHistory
                .filter((test) => test && test.TestDate && test.Summary) // Filter out invalid entries
                .slice(0, 5)
                .map((test, index) => (
                  <div
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <p className="text-sm leading-relaxed mb-2" style={{ color: theme.textPrimary }}>
                          {test.Summary && test.Summary.length > 150
                            ? `${test.Summary.substring(0, 150)}...`
                            : test.Summary || "אין תקציר זמין"}
                        </p>
                      </div>
                      {test.ImgURL && (
                        <div className="mr-4 flex-shrink-0">
