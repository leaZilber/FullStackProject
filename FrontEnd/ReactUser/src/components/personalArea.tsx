...
// export const PersonalArea = () => {
//   const [activeSection, setActiveSection] = useState<string>("uploadImage")
//   const [userName, setUserName] = useState<string>("אורח")
//   const [mobileOpen, setMobileOpen] = useState(false)
//   const isMobile = useMediaQuery(theme.breakpoints.down("md"))
...
//       try {
//         const response = await fetch("https://localhost:7245/api/User/5")
//         if (!response.ok) {
...
//           <Toolbar>
//             <Typography variant="h6" sx={{ flexGrow: 1 }}>
//               שלום, {userName !== "אורח" ? userName : "אורח"}
//             </Typography>
//             {isMobile && (
...
//         <Main open={!isMobile} sx={{ bgcolor: "#f0f0f0" }}>
//           <Toolbar />
//           <Paper elevation={2} sx={{ p: 3, mt: 2 }}>
//             {activeSection === "uploadImage" && <CheckPicture />}
//             {activeSection === "medicalHistory" && <MedicalHistory />}
