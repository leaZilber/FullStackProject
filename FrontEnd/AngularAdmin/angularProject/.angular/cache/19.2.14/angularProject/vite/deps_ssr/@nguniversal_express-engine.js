...
var require_terminal_highlight = __commonJS({
  "node_modules/postcss/lib/terminal-highlight.js"(exports, module) {
    ...
    function terminalHighlight(css) {
      let processor = tokenizer(new Input2(css), {
        ignoreErrors: true
      });
      let result = "";
    ...
    var PreviousMap = class {
      ...
      loadMap(file, prev) {
        ...
        if (prev) {
          ...
          if (file) map = join(dirname2(file), map);
...
// node_modules/critters/node_modules/htmlparser2/lib/esm/Tokenizer.js
var CharCodes2;
(function(CharCodes3) {
...
// node_modules/critters/node_modules/htmlparser2/lib/esm/Parser.js
...
// node_modules/critters/node_modules/htmlparser2/lib/esm/index.js
...
function serializeStylesheet(ast, options) {
  let cssStr = "";
  stringify2(ast, (result, node, type) => {
    var _node$raws;
    if (!options.compress) {
      cssStr += result;
      return;
...
function hasNestedRules(rule2) {
  return rule2.nodes && rule2.nodes.length && rule2.nodes.some((n) => n.type === "rule" || n.type === "atrule") && rule2.name !== "keyframes" && rule2.name !== "-webkit-keyframes";
}
    ...
    return __async(this, null, function* () {
      ...
      walkStyleRules(ast, markOnly((rule2) => {
        if (rule2.type === "comment") {
          const comment2 = rule2.text.trim();
          if (comment2.startsWith("critters")) {
            const command = comment2.replace(/^critters:/, "");
            switch (command) {
              case "include":
                includeNext = true;
                break;
        ...
        if (rule2.type === "rule") {
          ...
          if (rule2.nodes) {
            for (let i = 0; i < rule2.nodes.length; i++) {
              const decl2 = rule2.nodes[i];
              if (decl2.prop && decl2.prop.match(/\bfont(-family)?\b/i)) {
                criticalFonts += " " + decl2.value;
              }
              if (decl2.prop === "animation" || decl2.prop === "animation-name") {
                const names = decl2.value.split(/\s+/);
                for (let j = 0; j < names.length; j++) {
                  const name2 = names[j].trim();
                  if (name2) criticalKeyframeNames.push(name2);
                }
              }
            }
          }
        ...
        const rules = rule2.nodes && rule2.nodes.filter((rule3) => !rule3.$$remove);
  ...
  ${failedSelectors.join("\n  ")}`);
      ...
      walkStyleRulesWithReverseMirror(ast, astInverse, (rule2) => {
        ...
        if (rule2.type === "atrule" && rule2.name === "keyframes") {
          ...
          return criticalKeyframeNames.indexOf(rule2.params) !== -1;
        }
      ...
      if (options.pruneSource) {
        ...
        if (styleInlinedCompletely) {
          ...
          afterText = `, reducing non-inlined size ${percent2 | 0}% to ${(0, import_pretty_bytes.default)(sheetInverse.length)}`;
        }
      }
      if (!styleInlinedCompletely) {
        style.textContent = sheet;
      ...
      this.logger.info("\x1B[32mInlined " + (0, import_pretty_bytes.default)(sheet.length) + " (" + percent + "% of original " + (0, import_pretty_bytes.default)(before.length) + ") of " + name + afterText + ".\x1B[39m");
    });
  }
};
var critters_default = Critters;

// node_modules/@nguniversal/common/fesm2022/tools.mjs
...
var CrittersExtended = class extends critters_default {
  constructor(optionsExtended, resourceCache) {
    ...
    this.warnings = [];
    this.errors = [];
    this.addedCspScriptsDocuments = /* @__PURE__ */ new WeakSet();
    this.documentNonces = /* @__PURE__ */ new WeakMap();
    this.embedLinkedStylesheetOverride = (link, document2) => __async(this, null, function* () {
      ...
      if (cspNonce) {
        ...
        if (crittersMedia) {
          ...
          this.conditionallyInsertCspLoadingScript(document2, cspNonce);
        }
  ...
  readFile(path2) {
    return __async(this, null, function* () {
      ...
      if (resourceContent === void 0) {
        resourceContent = yield fs.promises.readFile(path2, "utf-8");
   ...
   */
  conditionallyInsertCspLoadingScript(document2, nonce) {
...
// node_modules/@nguniversal/common/fesm2022/engine.mjs
...
var CommonEngine = class {
  constructor(bootstrap, providers = []) {
    ...
    this.pageIsSSG = /* @__PURE__ */ new Map();
  ...
  render(opts) {
    return __async(this, null, function* () {
      ...
      if (opts.publicPath && opts.documentFilePath && opts.url !== void 0) {
        const url = new URL2(opts.url);
        ...
        if (pagePath !== resolve(opts.documentFilePath)) {
          ...
          if (pageIsSSG === void 0) {
            if (yield exists(pagePath)) {
              const content2 = yield fs2.promises.readFile(pagePath, "utf-8");
              const isSSG = SSG_MARKER_REGEXP.test(content2);
            ...
            return fs2.promises.readFile(pagePath, "utf-8");
          }
        }
      }
  ...
  getDocument(filePath) {
    return __async(this, null, function* () {
      ...
      if (!doc) {
        doc = yield fs2.promises.readFile(filePath, "utf-8");
...
function exists(path2) {
  return __async(this, null, function* () {
    try {
      yield fs2.promises.access(path2, fs2.constants.F_OK);
      return true;
    } catch {
      return false;
    }
...
// node_modules/@nguniversal/express-engine/fesm2022/tokens.mjs
var REQUEST = new InjectionToken("REQUEST");
var RESPONSE = new InjectionToken("RESPONSE");

// node_modules/@nguniversal/express-engine/fesm2022/express-engine.mjs
...
//# sourceMappingURL=@nguniversal_express-engine.js.map
