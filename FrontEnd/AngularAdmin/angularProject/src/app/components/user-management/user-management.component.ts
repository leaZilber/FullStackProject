...
//   openEditUserDialog(user: RegisterPostModel): void {
//     const dialogRef = this.dialog.open(UserDialogComponent, {
//       width: '600px',
...
//   openDeleteConfirmDialog(user: RegisterPostModel): void {
//     const dialogRef = this.dialog.open(ConfirmDialogComponent, {
//       width: '400px',
//       data: {
//         title: 'מחיקת משתמש',
//         message: `האם אתה בטוח שברצונך למחוק את המשתמש "${user.userName}"?`,
//         confirmText: 'מחק',
//         cancelText: 'ביטול'
//       }
//     });
...
//   updateUser(userData: RegisterPostModel): void {
//     this.isLoading = true;
